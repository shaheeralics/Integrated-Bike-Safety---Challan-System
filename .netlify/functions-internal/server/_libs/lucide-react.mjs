...
const Cctv = createLucideIcon("cctv", __iconNode$E);
const __iconNode$D = [
...
const PlugZap = createLucideIcon("plug-zap", __iconNode$i);
const __iconNode$h = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
...
const ServerCrash = createLucideIcon("server-crash", __iconNode$a);
const __iconNode$9 = [
  [
    "path",
    {
